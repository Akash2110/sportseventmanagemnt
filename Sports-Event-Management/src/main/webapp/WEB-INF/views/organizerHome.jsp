			...
			<div class="row">
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
					<div class="box-part text-center">
						<div class="title">
							<h4>Add Sports Type</h4>
						</div>
						<div class="text">
							<span>It will redirect to the page where you can add a
								sport type.</span> <a href="sportRegistration"><button
				...
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
					<div class="box-part text-center">
						...
						<div class="text">
							<span>It will redirect to the page where you can create
								Event.</span> <a href="eventRegistration"><button type="submit"
									class="btn btn-block">Add Event</button></a>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
...
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
					<div class="box-part text-center">
						...
						<div class="text">
							<span>It will redirect to the page where you can view event report
								</span> <a href="eventList"><button type="submit"
									class="btn btn-block">Event Report</button></a>
						</div>
					</div>
				</div>
